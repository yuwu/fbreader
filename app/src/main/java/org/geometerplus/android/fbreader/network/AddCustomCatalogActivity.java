		...
		setupButton(
			R.id.ok_button, "ok", new View.OnClickListener() {
				public void onClick(View view) {
					...
					imm.hideSoftInputFromWindow(((EditText)findViewById(R.id.add_custom_catalog_url)).getWindowToken(), 0);
					imm.hideSoftInputFromWindow(((EditText)findViewById(R.id.add_custom_catalog_title)).getWindowToken(), 0);
					imm.hideSoftInputFromWindow(((EditText)findViewById(R.id.add_custom_catalog_summary)).getWindowToken(), 0);
					onOkButton();
				}
			}
		);
